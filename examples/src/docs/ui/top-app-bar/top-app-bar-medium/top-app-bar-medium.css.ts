...
.ui-top-app-bar-medium {
  ...
  --ui-top-app-bar-medium-container-padding-right: calc(
    var(--ui-sys-unit) * 16
  );

  --ui-top-app-bar-medium-headline-font: var(
    --ui-sys-typescale-headline-small-font-family-name
  );
  --ui-top-app-bar-medium-headline-size: var(
    --ui-sys-typescale-headline-small-font-size
  );
  --ui-top-app-bar-medium-headline-weight: var(
    --ui-sys-typescale-headline-small-font-weight
  );
  --ui-top-app-bar-medium-headline-line-height: var(
    --ui-sys-typescale-headline-small-line-height
  );
